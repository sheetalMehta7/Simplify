...
const Home = () => {
  ...
  return (
    <div className='overflow-x-hidden w-screen'>
      <OuterHeader toggleModal={toggleModal}/>
      <section className="bg-zinc-950 py-20">
        <div className="max-w-5xl mx-auto text-center text-textPrimary px-4">
          ...
          <div className="space-x-4">
            ...
            <button className="px-8 py-3 bg-transparent border-2 border-violet-500 text-violet-500 rounded-full hover:bg-violet-500 hover:text-white transform hover:scale-105 transition" onClick={toggleModal}>Login</button>
          </div>
