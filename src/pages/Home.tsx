      ...
      <section className="bg-slate-950 py-20">
        <div className="max-w-5xl mx-auto text-center text-textPrimary px-4">
          ...
          <div className="space-x-4">
            <button className="px-8 py-3 bg-violet-500 text-white rounded-full hover:bg-violet-600 transform hover:scale-105 transition" onClick={() => toggleModal(modalTypes.signupModal)}>Sign up for free</button>
            <button className="px-8 py-3 bg-transparent border-2 border-violet-500 text-violet-500 rounded-full hover:bg-violet-500 hover:text-white transform hover:scale-105 transition" onClick={() => toggleModal(modalTypes.loginModal)}>Login</button>
          </div>
          <div className="mt-16 border rounded-2xl overflow-hidden p-8 border-violet-500 hover:bg-violet-950 transition">
